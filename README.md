...
|---|---|---|
| 0 | Apertura | Tre risposte prima di ogni formula. **Le due strade**: un algoritmo che si esegue passo passo (sei carte da ordinare, con la regola illuminata a lato) accanto a una cifra mai vista riconosciuta dalla rete già addestrata — esecuzione contro apprendimento, uno accanto all'altro. **Perché serve**: quattro cifre «sette» vere, sempre diverse, che nessuna regola scritta riesce a descrivere (pulsante «altri quattro»). **Che cos'è**: una scatola con due manopole che *il pubblico gira a mano* per far azzeccare alla macchina cinque prezzi, con il termometro «acqua–fuochino–fuoco» al posto della funzione di costo, **la formula scritta sotto la scatola** con i due numeri colorati che cambiano insieme alle manopole, **la mappa dell'errore** dove il puntino si muove mentre si gira, e il confronto finale con la discesa automatica che scende fino alla stellina. **Quanto è grande**: la riga a potenze di dieci con le manopole delle tre macchine della lezione (2 → 50.890 → mille miliardi). Poi una curva con **quattro manopole visibili**: si vedono gli errori misurati, la freccia che dice da che parte girare ogni manopola, le lancette che si spostano e l'errore che scende. Modalità «un passo alla volta» che racconta le quattro fasi, e cursore del passo di apprendimento (troppo grande = la curva schizza via). |
| 1 | La retta che indovina | Regressione polinomiale interattiva: si aggiungono punti col mouse, si alza la complessità, **arriva una casa nuova mai vista** e si vede di quanto la curva sbaglia su di lei, si nascondono dati per verificare. Sovradattamento e discesa del gradiente sulla «collina dell'errore» (curve di livello). |
| 2 | Con o senza risposte giuste | Un gioco per smistare sei lavori fra supervisionato e non supervisionato; **la stessa nuvola di punti (altezze di padri e figli) con due rette diverse** — una supervisionata (errore verticale) e una non supervisionata che minimizza le distanze perpendicolari (Pearson 1901); le **k-medie animate** che trovano i gruppi di case senza che nessuno glieli abbia detti; e un punto sballato da trascinare per vedere che **la funzione di costo decide la risposta** (quadratico contro assoluto). |
| 3 | Da una retta a qualsiasi curva | Somma di sigmoidi: da 1 a 40 neuroni, con i singoli pezzetti in vista. Si può disegnare la curva obiettivo a mano libera. **Un neurone solo in azione**: tre manopole (dove si accende, quanto in fretta, quanto conta) e il gradino morbido che ne esce, con la formula che si aggiorna e l'opzione di sommarne due per vedere nascere una collina. Due modi di trovare le manopole: **la formula** (minimi quadrati, istantanea) oppure **a tentoni come una rete vera** — allenamento dal vivo di pesi, pendenze e centri con Adam, curva dell'errore inclusa. Teorema di approssimazione universale. |
| 4 | La rete neurale: com'è fatta, come impara | **Un'immagine è una fila di numeri**: una cifra vera srotolata riga per riga in una striscia di 784 caselle. **Un neurone solo**: pesi, somma, soglia e lampadina, su una decisione quotidiana (McCulloch & Pitts 1943). **Una rete intera con tutti i fili in vista**: 9 quadretti → 4 neuroni → 2 risposte, 58 manopole, il segnale che scorre lungo i collegamenti. **La colpa all'indietro**: le quattro fasi della retropropagazione al rallentatore su un esempio, poi l'allenamento veloce con i fili che si ingrossano. E poi la rete 784–64–10 **addestrata davvero** su 8.000 cifre MNIST (96,5 % su cifre mai viste). Si disegna una cifra, si vedono i 64 neuroni accendersi e le maschere che hanno imparato. In fondo, il **laboratorio**: una seconda rete 784–24–10 parte da zero e si allena **dal vivo nel browser** su 1.200 cifre vere — le maschere emergono dal rumore, le risposte esatte salgono, e la previsione sulla cifra disegnata dal pubblico cambia mentre studia. **Cliccando una maschera** si vede il conto per esteso: cifra × maschera = quello che conta, e la somma che accende o spegne il neurone. |
| 5 | Il modello linguistico: com'è fatto, come impara | **La catena di montaggio** in cinque caselle cliccabili, ognuna con i dati veri della frase scritta dal pubblico (pezzetti, numeri, blocchi impilati fino a 96 come GPT-3, punteggi su tutto il vocabolario, sorteggio). **Il gioco della parola coperta**: un modello neurale vero allenato dal vivo che passa dall'1 % al 97 % sulla parola giusta — l'auto-supervisione, vista funzionare. Più tokenizzazione; modello a n-grammi costruito dal vivo sul testo scelto, con temperatura e tabella delle probabilità che **si riempie sotto gli occhi** mentre il modello legge il testo, parola per parola; piccolo modello neurale (Bengio 2003) allenato nel browser, con le parole che diventano punti; schema dell'attenzione. |
...
livello **Essenziale / Completa** decide quante diapositive ci sono (39 in essenziale, 41 in completa). Per una dispensa cartacea basta stampare la pagina normale: la stampa
